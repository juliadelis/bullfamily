...
export default function ImoveisAlugadosRelatorio() {
  ...
  const calculateDaysOccupied = (startDate: Date) => {
    if (!startDate) return "Data inválida";

    const today = new Date();
    return differenceInDays(today, new Date(startDate));
  };
                  ...
                  <TableBody>
                    {estates?.map((item, i) => (
                      <TableRow key={i}>
                        ...
                        <TableCell className="font-medium ">
                          {item.startDate
                            ? calculateDaysOccupied(new Date(item.startDate)) +
                              " dias"
                            : "Não existe data de ocupação"}
                        </TableCell>
                        <TableCell className="font-medium ">
                          {item.proprietary}
                        </TableCell>
