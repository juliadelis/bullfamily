  ...
  async function onSubmit({
    ...
    const success = await registerAction(
      ...
      "editar pagamento",
      {
        ...
        gasValue: gasValue ? Number(gasValue) : null,
        enelValue: enelValue ? Number(enelValue) : null,
        sabespValue: sabespValue ? Number(sabespValue) : null,
        condominiumValue: condominiumValue ? Number(condominiumValue) : null,
        rentValue: rentValue ? Number(rentValue) : null,
        propertyTaxIPTUValue: propertyTaxIPTUValue
          ? Number(propertyTaxIPTUValue)
          : null,
        rentPerson,
        condominiumPerson,
        sabespPerson,
