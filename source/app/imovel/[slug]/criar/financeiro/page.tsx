  ...
  async function onSubmit({
    ...
    const success = await registerAction(
      ...
      "adicionar pagamento",
      {
        ...
        year,
        observations,
        propertyTaxIPTU: propertyTaxIPTU ? new Date(propertyTaxIPTU) : null,
        propertyTaxIPTUValue,
        condominiumValue,
        enelValue,
        extra: extra ? new Date(extra) : null,
        extraStatus,
        extraValue,
        gasValue,
        rentValue,
        sabespValue,
        gas: gas ? new Date(gas) : null,
        enel: enel ? new Date(enel) : null,
        rent: rent ? new Date(rent) : null,
        sabesp: sabesp ? new Date(sabesp) : null,
        condominium: condominium ? new Date(condominium) : null,
